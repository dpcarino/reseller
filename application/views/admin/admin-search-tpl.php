            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo site_url('/admin/heads/search'); ?>">Admins</a>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Admin Details
                            </div>
                            <div class="actions">
                                <a href="<?php echo site_url('admin/detail/0'); ?>" class="btn default yellow-stripe">
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'admin/admin/ajax/get_search_result', // ajax source
                },
                "order": [
                    [0, "desc"]
