...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Rewards Claim Details - <?php echo $trackingcode; ?></h3>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Claim Details
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="user" class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:85%">
                                    <?php echo $claim_info->total_stars; ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:15%"> Total Rewards </td>
                                <td style="width:85%">
                                    <?php echo $claim_info->total_rewards; ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:15%"> Total Request </td>
                                <td style="width:85%">
                                    <?php echo $claim_request_counts; ?>
                                </td>
                            </tr>                            
                        </tbody>
                    </table>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <tr role="row" class="heading">
                                <th width="5%">Rewards Claim ID</th>
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'admin/claims/ajax/get_claims_processed_request', // ajax source                
                },
                "order": [
                    [0, "desc"]
