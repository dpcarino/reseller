...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Leadership Level Details - <?php echo $transaction_id; ?></h3>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <a href="<?php echo site_url('admin/leadership/export-breakdown').'/'.$details_id.'/'.$transaction_id; ?>" class="btn default yellow-stripe">
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <tr role="row" class="heading">
                                <th width="5%">Leader Name</th>
                                <th width="5%">Downline Head</th>
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'admin/leadership/ajax/get_leadership_history_level', // ajax source
                    "data": {
                        "details_id": "<?php echo $details_id; ?>",
