...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Reseller Voucher Details - <?php echo $trackingcode; ?></h3>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Reseller Voucher Details
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="user" class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:85%">
                                    <?php echo $payout_info->total_voucher_amount; ?>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <tr role="row" class="heading">
                                <th width="5%">Voucher Claim ID</th>
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'admin/reseller/ajax/get_reseller_voucher_processed_request', // ajax source                
                },
                "order": [
                    [0, "desc"]
