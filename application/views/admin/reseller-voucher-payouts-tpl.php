...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title">Reseller Voucher Payouts</h3>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-grid"></i>Reseller Voucher Payouts
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <tr role="row" class="heading">
                                ...
                                <th width="10%">Total Voucher Amount</th>
                                <th width="10%">Total Requests</th>
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'admin/reseller/ajax/get_reseller_voucher_payouts', // ajax source
                },
                "order": [
                    [0, "desc"]
