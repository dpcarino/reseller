...
<div class="page-content-wrapper">
	...
	<div class="page-content" style="min-height: 1435px;">
	    <!-- BEGIN PAGE HEADER-->
	    <h1 class="page-title"> Used Codes History</h1>
	    <div class="page-bar">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        ...
                        <tr role="row" class="heading">
                            <th width="20%">Code</th>
                            <th width="8%">Used By</th>
                            <th width="8%">Used To</th>
                            <th width="10%">Date of Used</th>
                            <th width="15%">
                                 Actions
                            </th>
                        </tr>
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'codes/ajax/used_code_history_listings', // ajax source
                },
                "order": [
                    [0, "desc"]
