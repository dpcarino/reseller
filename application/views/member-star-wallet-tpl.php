        ...
        <div class="row">
            <div class="col-lg-12 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup" data-value="<?php echo number_format($member_star_wallet_info->stars); ?>">0</span>
                            star(s)
                        </div>
                        <div class="desc"> Current Star Wallet </div>
                    </div>
                </a>
            </div>
        </div>        
...
$("#cancel-yes").on('click', function (){
    ...
    $.ajax({
        url: base_url+"transactions/ajax/set-star-head",
        data:{'head_id' : head_id},
        success: function(data) {           
            if(data.status == 'success'){
                window.location.href = base_url+'transactions/move-to-star-wallet/';
            }                
        },
        type: 'POST',
    });
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'transactions/ajax/get_star_heads', // ajax source
                },
                "order": [
                    [0, "desc"]
