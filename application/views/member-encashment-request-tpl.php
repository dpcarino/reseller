...
<div class="page-content-wrapper">
	...
	<div class="page-content" style="min-height: 1435px;">
	    <!-- BEGIN PAGE HEADER-->
	    <h1 class="page-title"> Request Encashment</h1>
	    <div class="page-bar">
    	        ...
    	        <div class="col-md-12">
                    ...
                    <?php if($member_details_info->encashment == 1): ?>
                        <div class="note note-danger">
                            <p> Dear member,</p>
                            <br>
                            <p> Encashment request will be de-activated after this encashment period, to fully enjoy please complete the ff in your profile page: </p>
                            <br>
                    ...
                    <div class="note note-warning">
                        <p> Dear member,</p>
                        <br>
                        <p>To activate request type BANK please update your banking informtion. click <a href="<?php echo site_url('profile'); ?>">HERE</a> to update</p><br>                        
                        <p> Thanks,</p>
                        <p> Essensa Administrator</p>
                    </div> 
                    <?php endif; ?>
                    <div class="portlet box yellow ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-money"></i> Encashment Details
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <?php echo form_open_multipart('request/encashment/', array('class'=>'form-horizontal', 'id'=>'request_form')); ?>
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" style="text-align: left; width: 15%;">Current Wallet: </label>
                                        <div class="col-md-9">
                                            <p class="form-control-static"> <?php echo number_format($member_wallet_info->amount); ?> </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" style="text-align: left; width: 15%;">Mininum Reward Request: </label>
                                        <div class="col-md-9">
                                            <p class="form-control-static"><?php echo $encashment_settings['minimum_request']; ?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" style="text-align: left; width: 15%;">Amount to Encash: </label>
                                        <div class="col-md-9">
                                            <input type="text" style="width: 50%;" class="form-control" placeholder="Enter Amount" onkeypress="return isNumberKey(event);" name="amount"> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" style="text-align: left; width: 15%;">Request Type: </label>
                                        <div class="col-md-9">
                                            <select name="request_type" style="width: 50%;" class="form-control">
