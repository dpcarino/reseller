...
<div class="page-content-wrapper">
	...
	<div class="page-content" style="min-height: 1435px;">
	    <!-- BEGIN PAGE HEADER-->
	    <h1 class="page-title">Leadership History Details - <?php echo $transaction_id; ?> </h1>
	    <div class="page-bar">
            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="actions">
                            <a href="<?php echo site_url('transactions/leadership-history'); ?>" class="btn default red-stripe">
    ...
    var handleCodes = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": base_url + 'transactions/ajax/get_history_level', // ajax source
                    "data": {
